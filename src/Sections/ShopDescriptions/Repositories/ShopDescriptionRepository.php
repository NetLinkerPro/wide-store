...
namespace NetLinker\WideStore\Sections\ShopDescriptions\Repositories;

use AwesIO\Repository\Eloquent\BaseRepository;
use Illuminate\Support\Facades\Auth;
use NetLinker\WideStore\Sections\ShopDescriptions\Models\ShopDescription;
use NetLinker\WideStore\Sections\ShopDescriptions\Scopes\ShopDescriptionScopes;
...
class ShopDescriptionRepository extends BaseRepository
{
    ...
    public function scope($request)
    {
        ...
        // apply custom scopes
        $this->entity = (new ShopDescriptionScopes($request))->scope($this->entity);
