...
namespace NetLinker\WideStore\Sections\ShopDescriptions\Models;
...
class ShopDescription extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_shop_descriptions';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','shop_uuid' , 'product_uuid', 'deliverer', 'description'];
