...
namespace NetLinker\WideStore\Sections\ShopStocks\Models;
...
class ShopStock extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_shop_stocks';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','shop_uuid' , 'product_uuid', 'deliverer', 'stock', 'availability', 'department'];
