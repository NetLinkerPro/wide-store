...
namespace NetLinker\WideStore\Sections\Descriptions\Models;
...
class Description extends Model
{
     ...
     * @var string
     */
    protected $table = 'wide_store_descriptions';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'product_uuid', 'deliverer' , 'description', 'lang', 'type'];
