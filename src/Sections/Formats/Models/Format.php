...
namespace NetLinker\WideStore\Sections\Formats\Models;
...
class Format extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_formats';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','name', 'product_uuid', 'description', 'configuration'];
