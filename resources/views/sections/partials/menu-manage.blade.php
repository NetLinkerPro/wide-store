<div class="filter__rlink">
    <context-menu button-class="filter__slink" right>
        <template slot="toggler">
            <span>{{ __('wide-store::general.integrations') }}</span>
        </template>
        @include('wide-store::sections.partials.integration-menu-manage')
    </context-menu>
</div>
<div class="filter__rlink">
    <context-menu button-class="filter__slink" right>
        <template slot="toggler">
            <span>{{ __('wide-store::general.formats') }}</span>
        </template>
        @include('wide-store::sections.partials.format-menu-manage')
    </context-menu>
</div>
<div class="filter__rlink">
    <context-menu button-class="filter__slink" right>
