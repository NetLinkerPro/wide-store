...
namespace NetLinker\WideStore\Sections\ShopProducts\Models;
...
class ShopProduct extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_shop_products';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid', 'source_uuid','shop_uuid' , 'category_uuid', 'deliverer', 'identifier', 'name', 'price', 'tax', 'url', 'complete', 'type'];
