...
namespace NetLinker\WideStore\Sections\Integrations\Models;
...
class Integration extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_integrations';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','deliverer_configuration_uuid', 'deliverer'];
