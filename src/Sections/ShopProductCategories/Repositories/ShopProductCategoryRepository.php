...
namespace NetLinker\WideStore\Sections\ShopProductCategories\Repositories;

use AwesIO\Repository\Eloquent\BaseRepository;
use Illuminate\Support\Facades\Auth;
use NetLinker\WideStore\Sections\ShopProductCategories\Models\ShopProductCategory;
use NetLinker\WideStore\Sections\ShopProductCategories\Scopes\ShopProductCategoryScopes;
...
class ShopProductCategoryRepository extends BaseRepository
{
    ...
    public function scope($request)
    {
        ...
        // apply custom scopes
        $this->entity = (new ShopProductCategoryScopes($request))->scope($this->entity);
