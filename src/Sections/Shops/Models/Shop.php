...
namespace NetLinker\WideStore\Sections\Shops\Models;
...
class Shop extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_shops';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','format_uuid', 'integration_uuid', 'name', 'description'];
