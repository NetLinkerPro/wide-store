...
namespace NetLinker\WideStore\Sections\IntegrationSchedulers\Models;
...
class IntegrationScheduler extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_integration_schedulers';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','integration_uuid', 'cron'];
