...
namespace NetLinker\WideStore\Sections\ShopAttributes\Models;
...
class ShopAttribute extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_shop_attributes';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','shop_uuid' , 'product_uuid', 'deliverer', 'name', 'value', 'order'];
