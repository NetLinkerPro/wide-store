...
namespace NetLinker\WideStore\Sections\ShopImages\Models;
...
class ShopImage extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_shop_images';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','shop_uuid' , 'product_uuid', 'deliverer', 'identifier', 'url_target', 'order','main'];
