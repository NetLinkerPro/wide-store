...
namespace NetLinker\WideStore\Sections\ShopProductCategories\Models;
...
class ShopProductCategory extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'wide_store_shop_product_categories';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','shop_uuid' , 'product_uuid', 'category_uuid','deliverer'];
